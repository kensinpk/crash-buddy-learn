  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        learning: "gradient-learning text-white hover:scale-105 shadow-lg hover:shadow-xl",
        success: "bg-success text-success-foreground hover:bg-success/90 hover:scale-105",
        buddy: "glass-card text-foreground hover:scale-105 border-2 border-transparent hover:border-primary/30",
        floating: "gradient-primary text-white hover:scale-110 shadow-lg hover:shadow-xl floating-animation",
